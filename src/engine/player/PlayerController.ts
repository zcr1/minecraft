...
export default class PlayerController extends Component {
    ...
    handleMovement() {
        ...
        } else if (this.playerPhysics.isInWater) {
            this.handleSwimmingMovement();
        } else {
    ...
    private handleSwimmingMovement() {
        let deltaX = 0;
        let deltaZ = 0;
        ...
        if (input.isHeld("Space")) {
            this.playerPhysics.velocity.y = SWIM_UP_SPEED;
        } else if (input.isHeld("ShiftLeft")) {
            this.playerPhysics.velocity.y = -SWIM_DOWN_SPEED;
        }
        ...
        this.playerPhysics.velocity.x = worldDeltaX * SWIM_SPEED;
        this.playerPhysics.velocity.z = worldDeltaZ * SWIM_SPEED;
    }
}
